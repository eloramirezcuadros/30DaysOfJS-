...
console.log(arr.split(' '));  //['JavaScript']


//10. Split the string 30 Days Of JavaScript at the space using split() method
const arra = '30 Days Of JavaScript';
console.log(arra.split(' '));  //['30 Days Of JavaScript']
...
console.log(occurr.indexOf('a'));  //4


//16. Use lastIndexOf to determine the position of the last occurrence of a in 30 Days Of JavaScript.
const occurre = '30 Days Of JavaScript';
console.log(occurre.lastIndexOf('a'));  //14
...
console.log(occurren.indexOf('because'));  //31
...
console.log(occurrenc.lastIndexOf('because'));  //47
...
console.log(occurrenc_e.search('because'));  //31
...
console.log(strin_g3.match(/of/gi));  //[ 'Of' ]
